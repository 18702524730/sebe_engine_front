		...
		<div class="file-uploader" :class="{'file-uploader-onbg': startShow}" @click="addFile">
			...
			<div v-if="uploadedFileData.url">
				<div class="success successImg" v-if="isPdf(suffix)">
					...
					<div class="mask"></div>
					<div class="hoveraction"><i class="el-icon-zoom-in" @click="openpdf"></i><i class="el-icon-circle-close" @click.stop="handleRemove()"></i></div>
				</div>
				<div class="success successImg" v-else-if="isImg(suffix)" @mouseenter="dialogImageUrl=url">
					<img :src="url">
					<div class="mask"></div>
					<div class="hoveraction"><i class="el-icon-zoom-in" @click="dialogImgVisible=true"></i><i class="el-icon-circle-close" @click.stop="handleRemove()"></i></div>
				</div>
